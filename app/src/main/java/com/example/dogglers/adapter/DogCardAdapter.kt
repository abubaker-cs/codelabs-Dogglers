...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val listDisplayMode = when (layout) {
        ...
        return DogCardViewHolder(listDisplayMode)
    }
    ...
    override fun onBindViewHolder(holder: DogCardAdapter.DogCardViewHolder, position: Int) {
        ...
        holder.dogImageView?.setImageResource(currentRecord.imageResourceId)
        holder.dogName?.text = currentRecord.name
        ...
        holder.dogHobby?.text = resources?.getString(R.string.dog_hobbies, currentRecord.hobbies)
